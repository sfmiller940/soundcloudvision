...
function initPlayer(){
	...
	// Add player html to body
	document.body.innerHTML += '<div id="SCV" style="position: fixed; top: 0; left: 0; height: 100%; width: 100%; background: #777;">' +
								 ...
								 '<div id="urlui" style="position: absolute; bottom: 60px; left: 0px; width: 100%; text-align: center;">' +
									...
									'</div>' + 
							   '</div>';
	// Add player and configure analyser						   
